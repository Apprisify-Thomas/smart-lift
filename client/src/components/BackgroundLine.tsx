...
export default function BackgroundLine() {
    ...
    useGSAP(() => {
        ...
        tl.to([path1.current, path2.current], {
            xPercent: -100,
            duration: duration,
            ease: "none",
            repeat: -1
