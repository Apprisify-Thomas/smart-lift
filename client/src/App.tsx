...
export default function App() {
  ...
  function ImageSlide({ floor, path }: { floor: number; path: string }) {
    ...
    return <div style={{ transform: "rotateY(-5deg)", position: "relative", left: 0, top: 0, right: 0, width: 580  }}>
  ...
  return (
    <>
      ...
      <div style={{ paddingTop: 80 }}>
        <div>
          <header style={{ display: "flex", justifyContent: "space-between", margin: "2rem auto 14rem auto", maxWidth: 900, perspective: "500px" }}>
          <div>
            <p style={{ fontSize: 40, fontWeight: 300, margin: 0 }}>Floor</p>
            <h2 className='flex gap-2' style={{ fontSize: 70, alignItems: "center", fontWeight: 700, margin: 0 }}>
              <NumberFlow 
        ...
        <div className='flex' style={{ margin: "0 auto", maxWidth: 900, }}>
        ...
        <div className='flex gap-10 justify-between' style={{ margin: "4rem auto", maxWidth: 900 }}>
          <div>
            ...
            <p className='text-3xl font-extralight'>122.5kg / 630kg</p>
          </div>
